...
Break a PRD into independently-grabbable linear tasks using vertical slices (tracer bullets).
...
Slices may be 'HITL' or 'AFK'. HITL slices require human interactfion, such as an architectural decision or a design review. AFK slices can be implemented and merged without human interaction. Prefer AFK over HITL where possible.
