...
Create a Linear issue using `linctl issue create` with the template below. Do NOT ask the user to review before creating - just create it and share the URL. Add the affected projects as labels and a `bug` label.
